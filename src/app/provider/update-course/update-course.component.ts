...
export class UpdateCourseComponent implements OnInit{
  ...
  public Delete(){
   ...
   const dele=confirm("do you really want to delete the course!");
   if(!dele)return;
  ...
  async onSubmit() {
   ...
   // console.log(content+" file c"+this.videoFile+" "+contentType);
    ...
    //  console.log(evt.loaded + ' of ' + evt.total + ' Bytes');
      ...
      this.http.put<any>('https://anbhkc01l2.execute-api.ap-northeast-1.amazonaws.com/Dev1/courses', formData,{
        reportProgress: true,
        observe: 'events',
    })
      .subscribe(event => {
